...
def init():
        ...
        def initmessageconstants():
            ...
            def initdialogandprompts():
                ...
                def renamefileprompt(oldname):
                    ispath = ("/" in oldname or "\\" in oldname)
                    newname = oldname
                    isnewpath = ispath
                    while (newname == oldname or iswhitespace(newname)) or fileexists(newname) or not(isnewpath or isvalidfilename(newname)):
                        newnamesuggestion = generateduplicatefilename(oldname)
                        if (newname == oldname or iswhitespace(newname)):
                            if ispath:
                                newname = prompt("The file '" + getfilename(oldname) + "' at path '" + oldname + "' already exists. Please enter a new name or path for it:\n")
                                isnewpath = ("/" in newname or "\\" in newname)
                            else:
                                newname = prompt("The file '" + getfilename(oldname) + "' already exists. Please enter a new name for it:\n")
                                isnewpath = False
                        else:
                            oldname = newname
                            if fileexists(newname):
                                #File already exists
                                if isnewpath:
                                    newname = prompt("The file '" + getfilename(newname) + "' at path '" + newname + "' already exists. Please enter a new name or path for it:\n")
                                else:
                                    if ispath:
                                        newname = prompt("The file '" + newname + "' at path '" + buildpath(getdirectory(oldname),newname) + "' already exists. Please enter a new name or path for it:\n")
                                    else:
                                        newname = prompt("The file '" + newname + "' already exists. Please enter a new name or path for it:\n")
                            else:
                                #Illegal file name
                                if ispath:
                                    newname = prompt("The file name '" + newname + "' is not legal. Try another name for file '" + newname + "' at path '" + buildpath(getdirectory(oldname),newname) + "':\n")
                                else:
                                    newname = prompt("The file name '" + newname + "' is not legal. Please enter a new name or path for it:\n")
                            isnewpath = ("/" in newname or "\\" in newname)
                global renamefolderprompt
                def renamefolderprompt(oldname):
                    ispath = ("/" in oldname or "\\" in oldname)
                    newname = oldname
                    isnewpath = ispath
                    while (newname == oldname or iswhitespace(newname)) or folderexists(newname) or not(isnewpath or isvalidfilename(newname)):
                        newnamesuggestion = generateduplicatefilename(oldname)
                        if (newname == oldname or iswhitespace(newname)):
                            if ispath:
                            ...
                            if folderexists(newname):
                                ...
                                if isnewpath:
                                    newname = prompt("The folder at path '" + newname + "' already exists. Please enter a new name or path for it:\n")
                                else:
                                    newname = prompt("The folder '" + newname + "' already exists. Please enter a new name or path for it:\n")
                            else:
                                #Illegal file name
                                if ispath:
                                    newname = prompt("The folder name '" + newname + "' is not legal. Try another name for folder '" + newname + "' at path '" + buildpath(getdirectory(oldname),newname) + "':\n")
                                else:
                                    newname = prompt("The folder name '" + newname + "' is not legal. Please enter a new name or path for it:\n")
                            isnewpath = ("/" in newname or "\\" in newname)
            initerrors()
...
def write_file(path,new,cancelifoverwrite = False):
...
def getmainactivityfilefromapk(apkpath,mainactivity,returntype = "path",notfounderror = True,recurse = 0): #make sure apk is decompiled!
    ...
    if not(found):
        ...
        return(getsubfile(apkpath,mainactivityfilepath,returntype))
...
class ModMenuInstall():
    def __init__(self,apkpath,newapkpath,modmenuapkpath,menutype = "LGL"):
        ...
        while folderexists(self.newapkpath):
            #best to overwrite, but let user have choice
            ...
            copyfolder(apkpath,newapkpath,cancelifoverwrite = "Warn")
...
menu = ModMenuInstall(apk,"hi",new,menutype = "LGL")
