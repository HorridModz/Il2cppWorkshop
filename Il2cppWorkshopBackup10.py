...
#If you have moved Il2cppWorkshop.py to a new directory, please replace the it with the correct path.
                ...
                def renamefileprompt(originalname):
                    ...
                    while (newname == originalname or iswhitespace(newname)) or fileexists(newname) or not(isnewpath or isvalidfilename(newname)):
                        if (newname == originalname or iswhitespace(newname)):
                            if ispath:
                                newname = prompt("The file '" + getfilename(originalname5) + "' at path '" + originalname + "' already exists. Please enter a new name or path for it:\n")
...
def skipspaces(fullstr,spacescount = 1,allwhitespace = True,backward = False,newstr = True):
    ...
    def islastwhitespace(fullstr,allwhitespace):
        ...
        if allwhitespace:
           return (contains(thisletter,_whitespacechars))
        else:
             return (thisletter == " ")
    '''
...
def read_file(path,readtype = "r",hexmode = True):
...
def warning(message,warningtype = "Warning Type Not Specified",actions= ["log","print"]):
...
def generateaob(armcode,hexstring):
    ...
    pass
"""
hexstring = FF C3 00 D1 F4 4F 01 A9 FD 7B 02 A9 FD 83 00 91 34 04 02 B0 88 1A 7E 39 F3 03 00 AA E8 00 00 37 88 DA 01 D0 08 4D 44 F9 00 01 40 B9 2D A0 5C 97 E8 03 00 32 88 1A 3E 39 FF 07 00 F9 60 62 40 B9 1F 00 00 71 8C 02 00 54 08 DA 01 90 08 39 47 F9 74 42 00 91 E0 03 14 AA 01 01 40 F9 35 6D 4B 94 80 00 00 37 E0 03 13 AA E1 03 1F 2A 0E 00 00 94 68 D3 01 B0 08 E5 44 F9 E0 03 14 AA 01 01 40 F9 2E 6D 4B 94 E0 07 00 F9 E0 23 00 91 E1 03 1F AA B0 FE 1A 94 FD 7B 42 A9 F4 4F 41 A9 FF C3 00 91 C0
armcode = SUB             SP, SP, #0x30\
STP             X20, X19, [SP,#0x20+var_10]\
STP             X29, X30, [SP,#0x20+var_s0]\
...
il2cpp:000000000452F8E8 FF C3 00 D1                             SUB             SP, SP, #0x30
il2cpp:000000000452F8EC F4 4F 01 A9                             STP             X20, X19, [SP,#0x20+var_10]
il2cpp:000000000452F8F0 FD 7B 02 A9                             STP             X29, X30, [SP,#0x20+var_s0]
il2cpp:000000000452F8F4 FD 83 00 91                             ADD             X29, SP, #0x20
il2cpp:000000000452F8F8 34 04 02 B0                             ADRP            X20, #byte_85B4F86@PAGE
il2cpp:000000000452F8FC 88 1A 7E 39                             LDRB            W8, [X20,#byte_85B4F86@PAGEOFF]
il2cpp:000000000452F900 F3 03 00 AA                             MOV             X19, X0
il2cpp:000000000452F904 E8 00 00 37                             TBNZ            W8, #0, loc_452F920
il2cpp:000000000452F908 88 DA 01 D0                             ADRP            X8, #off_8081898@PAGE
il2cpp:000000000452F90C 08 4D 44 F9                             LDR             X8, [X8,#off_8081898@PAGEOFF]
il2cpp:000000000452F910 00 01 40 B9                             LDR             W0, [X8]
il2cpp:000000000452F914 2D A0 5C 97                             BL              sub_1C579C8
il2cpp:000000000452F918 E8 03 00 32                             MOV             W8, #1
il2cpp:000000000452F91C 88 1A 3E 39                             STRB            W8, [X20,#byte_85B4F86@PAGEOFF]
il2cpp:000000000452F920
il2cpp:000000000452F920                         loc_452F920                             ; CODE XREF: sub_452F8E8+1C↑j
il2cpp:000000000452F920 FF 07 00 F9                             STR             XZR, [SP,#0x20+var_18]
il2cpp:000000000452F924 60 62 40 B9                             LDR             W0, [X19,#0x60]
il2cpp:000000000452F928 1F 00 00 71                             CMP             W0, #0
il2cpp:000000000452F92C 8C 02 00 54                             B.GT            loc_452F97C
il2cpp:000000000452F930 08 DA 01 90                             ADRP            X8, #off_806FE70@PAGE
il2cpp:000000000452F934 08 39 47 F9                             LDR             X8, [X8,#off_806FE70@PAGEOFF]
il2cpp:000000000452F938 74 42 00 91                             ADD             X20, X19, #0x10
il2cpp:000000000452F93C E0 03 14 AA                             MOV             X0, X20
il2cpp:000000000452F940 01 01 40 F9                             LDR             X1, [X8]
il2cpp:000000000452F944 35 6D 4B 94                             BL              sub_580AE18
il2cpp:000000000452F948 80 00 00 37                             TBNZ            W0, #0, loc_452F958
il2cpp:000000000452F94C E0 03 13 AA                             MOV             X0, X19
il2cpp:000000000452F950 E1 03 1F 2A                             MOV             W1, WZR
il2cpp:000000000452F954 0E 00 00 94                             BL              sub_452F98C
il2cpp:000000000452F958
il2cpp:000000000452F958                         loc_452F958                             ; CODE XREF: sub_452F8E8+60↑j
il2cpp:000000000452F958 68 D3 01 B0                             ADRP            X8, #off_7F9C9C8@PAGE
il2cpp:000000000452F95C 08 E5 44 F9                             LDR             X8, [X8,#off_7F9C9C8@PAGEOFF]
il2cpp:000000000452F960 E0 03 14 AA                             MOV             X0, X20
il2cpp:000000000452F964 01 01 40 F9                             LDR             X1, [X8]
il2cpp:000000000452F968 2E 6D 4B 94                             BL              sub_580AE20
il2cpp:000000000452F96C E0 07 00 F9                             STR             X0, [SP,#0x20+var_18]
il2cpp:000000000452F970 E0 23 00 91                             ADD             X0, SP, #0x20+var_18
il2cpp:000000000452F974 E1 03 1F AA                             MOV             X1, XZR
il2cpp:000000000452F978 B0 FE 1A 94                             BL              sub_4BEF438
il2cpp:000000000452F97C
il2cpp:000000000452F97C                         loc_452F97C                             ; CODE XREF: sub_452F8E8+44↑j
il2cpp:000000000452F97C FD 7B 42 A9                             LDP             X29, X30, [SP,#0x20+var_s0]
il2cpp:000000000452F980 F4 4F 41 A9                             LDP             X20, X19, [SP,#0x20+var_10]
il2cpp:000000000452F984 FF C3 00 91                             ADD             SP, SP, #0x30 ; '0'
il2cpp:000000000452F988 C0 03 5F D6                             RET
il2cpp:000000000452F988                         ; } // starts at 452F8E8
il2cpp:000000000452F988                         ; End of function sub_452F8E8
"""
...
def getstaticbytes(hexlist,returnsep = " "):
    if len(hexlist) < 3:
        if len(hexlist) == 1:
            return(hexlist[0])
        elif len(hexlist) == 0:
    ...
    for thisbyte in possiblebytes:
        ...
        if bytefrequency[byteindex] == len(bytelists) + 1: #Add 1 because we deleted the original
            ...
            #Changing byte
            staticbytes.append("??")
    statichexstring = concat(staticbytes,returnsep)
    #To-do: Trim leading and trailing ?? to avoid redundancy
...
class ModMenuInstall():
    def __init__(self,apkpath,newapkpath,modmenuapkpath,menutype = "LGL"):
        ...
        if folderexists(self.newapkpath):
            ...
            choice = "Keep"
            if choice == "Overwrite":
                copyfolder(apkpath,self.newapkpath,cancelifoverwrite = False)
            elif choice == "Cancel":
...
init()
a = "30 48 2D E9 08 B0 8D E2 08 D0 4D E2 00 40 A0 E1 9C 00 9F E5 00 00 8F E0 00 00 D0 E5 00 00 50 E3 06 00 00 1A 8C 00 9F E5 00 00 9F E7 00 00 90 E5 D5 1C 08 EB 80 00 9F E5 01 10 A0 E3 00 10 CF E7 00 00 A0 E3 04 00 8D E5 00 00 8D E5 3C 00 94 E5 00 00 50 E3 14 00 00 CA 60 00 9F E5 08 50 84 E2 00 00 9F E7 00 10 90 E5 05 00 A0 E1 08 30 58 EB 00 00 50 E3 02 00 00 1A 04 00 A0 E1 00 10 A0 E3 10 00 00 EB 38 00 9F E5 0D 40 A0 E1 05 10 A0 E1 00 00 9F E7 00 20 90 E5 04 00 A0 E1 FE 2F 58 EB 04 00 A0 E1 00"
b = "30 48 2D E9 08 B0 8D E2 08 D0 4D E2 00 40 A0 E1 9C 00 9F E5 00 00 8F E0 00 00 D0 E5 00 00 50 E3 06 00 00 1A 8C 00 9F E5 00 00 9F E7 00 00 90 E5 B4 E6 05 EB 80 00 9F E5 01 10 A0 E3 00 10 CF E7 00 00 A0 E3 04 00 8D E5 00 00 8D E5 3C 00 94 E5 00 00 50 E3 14 00 00 CA 60 00 9F E5 08 50 84 E2 00 00 9F E7 00 10 90 E5 05 00 A0 E1 C9 E3 05 EB 00 00 50 E3 02 00 00 1A 04 00 A0 E1 00 10 A0 E3 A5 0E 00 EB 38 00 9F E5 0D 40 A0 E1 05 10 A0 E1 00 00 9F E7 00 20 90 E5 04 00 A0 E1 50 E7 05 EB 04 00 A0 E1 00"
print(findstaticbytes([a,b]))
sys.exit()
...
apk = r"C:/Users/zachy/OneDrive/Documents/APK Easy Tool/1-Decompiled APKs/Bullet Force V1.88.1"
#new = r"C:\Users\zachy\OneDrive\Documents\APK Easy Tool\1-Decompiled APKs\New Pixel Gun 3D 16.6.1 Armv7"
new = r"C:/Users/zachy/OneDrive/Documents/APK Easy Tool/1-Decompiled APKs/New Bullet Force V1.88.1"
menu = ModMenuInstall(apk,new,"hi",menutype = "LGL")
